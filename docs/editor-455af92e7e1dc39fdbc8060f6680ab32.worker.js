!(function (e) {
  ...
  function (e, t, n) {
    ...
    ;(function (e, i) {
      ...
      let p = void 0
      void 0 !== i ? (p = i) : void 0 !== _.vscode && (p = _.vscode.process)
      const C =
          'string' ==
      ...
      ;(() => {
        ...
        const e = null == p ? void 0 : p.env.ENABLE_VSCODE_BROWSER_CODE_LOADING
      })()
          ...
          if ('function' == typeof y.postMessage && !y.importScripts) {
            ...
            return n => {
              ...
              e.push({ id: i, callback: n }),
                y.postMessage({ vscodeSetImmediateId: i }, '*')
            }
          }
          if (p && 'function' == typeof p.nextTick) return p.nextTick.bind(p)
  ...
  function (e, t, n) {
    ...
    function S(e, t) {
      return (
        (function e(t, n, i, r, s) {
          if (r <= i) return
          const o = (i + (r - i) / 2) | 0
          if ((e(t, n, i, o, s), e(t, n, o + 1, r, s), n(t[o], t[o + 1]) <= 0))
            return
          !(function (e, t, n, i, r, s) {
            let o = n,
              a = i + 1
            for (let t = n; t <= r; t++) s[t] = e[t]
            for (let l = n; l <= r; l++)
              o > i
                ? (e[l] = s[a++])
                : a > r
    ...
    function x(e, t = 0, n = e.byteLength, i = 0) {
      ...
      digest() {
        return (
          this._finished ||
            ...
            this._wrapUp()),
          I(this._h0) + I(this._h1) + I(this._h2) + I(this._h3) + I(this._h4)
        )
      }
      _wrapUp() {
        ;(this._buff[this._buffLen++] = 128),
          x(this._buff, this._buffLen),
          this._buffLen > 56 && (this._step(), x(this._buff))
      ...
      _step() {
        ...
        for (let t = 0; t < 80; t++)
          t < 20
            ...
            (r = (O(s, 5) + n + u + i + e.getUint32(4 * t, !1)) & 4294967295),
            (u = l),
            (l = a),
            (a = O(o, 30)),
            (o = s),
    ...
    function R(e, t, n) {
      return new F(new P(e), new P(t)).ComputeDiff(n).changes
    }
    class k {
      static Assert(e, t) {
    ...
    class F {
      constructor(e, t, n = null) {
        ...
        const [i, r, s] = F._getElements(e),
          [o, a, l] = F._getElements(t)
      ...
      static _getElements(e) {
        ...
        if (F._isStringArray(t)) {
          ...
          for (let n = 0, i = t.length; n < i; n++) e[n] = T(t[n], 0)
          return [t, e, !0]
        }
      ...
      ComputeRecursionPoint(e, t, n, i, r, s, o) {
        ...
        for (let E = 1; E <= f / 2 + 1; E++) {
          ...
          for (let f = c; f <= d; f += 2) {
            ...
            if (((_[f] = a), S && Math.abs(f - p) <= E && a <= g[f]))
              return (
                (r[0] = a),
                (s[0] = l),
                m >= g[f] && E <= 1448
      ...
      ConcatenateChanges(e, t) {
        ...
        if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
          ...
          return (
            U.Copy(e, 0, i, 0, e.length - 1),
            (i[e.length - 1] = n[0]),
            U.Copy(t, 1, i, e.length, t.length - 1),
            i
          )
        }
        {
          ...
          return (
            U.Copy(e, 0, n, 0, e.length), U.Copy(t, 0, n, e.length, t.length), n
          )
        }
      }
    ...
    function W(e, t) {
      if ('string' != typeof e) throw new B(t, 'string', e)
    }
    function q(e) {
      return 47 === e || 92 === e
    }
    ...
    function $(e, t) {
      if (null === t || 'object' != typeof t)
        throw new B('pathObject', 'Object', t)
    ...
    const j = {
        resolve(...e) {
          ...
          for (let r = e.length - 1; r >= -1; r--) {
            let s
            if (r >= 0) {
              if (((s = e[r]), W(s, 'path'), 0 === s.length)) continue
            } else
              0 === t.length
                ? (s = K.a())
                : ((s = K.b['=' + t] || K.a()),
            ...
            if (1 === o) q(h) && ((a = 1), (u = !0))
              ...
              if (((u = !0), q(s.charCodeAt(1)))) {
                let e = 2,
                  t = e
                for (; e < o && !q(s.charCodeAt(e)); ) e++
                if (e < o && e !== t) {
                  const n = s.slice(t, e)
                  for (t = e; e < o && q(s.charCodeAt(e)); ) e++
                  if (e < o && e !== t) {
                    for (t = e; e < o && !q(s.charCodeAt(e)); ) e++
                    ;(e !== o && e === t) ||
                      ((l = `\\\\${n}\\${s.slice(t, e)}`), (a = e))
        ...
        normalize(e) {
          ...
          if (q(s))
            if (((r = !0), q(e.charCodeAt(1)))) {
              ...
              if (r < t && r !== s) {
                const o = e.slice(s, r)
                for (s = r; r < t && q(e.charCodeAt(r)); ) r++
                if (r < t && r !== s) {
                  for (s = r; r < t && !q(e.charCodeAt(r)); ) r++
          ...
          let o = i < t ? Y(e.slice(i), !r, '\\', q) : ''
          return (
            0 !== o.length || r || (o = '.'),
            o.length > 0 && q(e.charCodeAt(t - 1)) && (o += '\\'),
        ...
        isAbsolute(e) {
          ...
          return (
            q(n) ||
            (t > 2 && V(n) && 58 === e.charCodeAt(1) && q(e.charCodeAt(2)))
          )
        },
        join(...e) {
      ...
      G = {
        resolve(...e) {
          ...
          return (t = Y(t, !n, '/', H)), n ? '/' + t : t.length > 0 ? t : '.'
        },
        normalize(e) {
          if ((W(e, 'path'), 0 === e.length)) return '.'
          const t = 47 === e.charCodeAt(0),
            n = 47 === e.charCodeAt(e.length - 1)
          return 0 === (e = Y(e, !t, '/', H)).length
            ? t
              ? '/'
              : n
              ? './'
        ...
        isAbsolute: e => (W(e, 'path'), e.length > 0 && 47 === e.charCodeAt(0)),
        join(...e) {
          if (0 === e.length) return '.'
          let t
          ...
          return void 0 === t ? '.' : G.normalize(t)
        },
        relative(e, t) {
          if ((W(e, 'from'), W(t, 'to'), e === t)) return ''
          if ((e = G.resolve(e)) === (t = G.resolve(t))) return ''
          const n = e.length,
            i = n - 1,
            r = t.length - 1,
            s = i < r ? i : r
    ...
    ;(G.win32 = j.win32 = j), (G.posix = j.posix = G)
    'win32' === K.c ? j.normalize : G.normalize,
      'win32' === K.c ? j.resolve : G.resolve,
      'win32' === K.c ? j.relative : G.relative,
      'win32' === K.c ? j.dirname : G.dirname,
      'win32' === K.c ? j.basename : G.basename,
      'win32' === K.c ? j.extname : G.extname,
      'win32' === K.c ? j.sep : G.sep
    const z = /^\w[\w\d+.-]*$/,
      Q = /^\//,
      X = /^\/\//
    const Z = '/',
    ...
    class ee {
      ...
      static from(e) {
        return new ne(e.scheme, e.authority, e.path, e.query, e.fragment)
      }
      static joinPath(e, ...t) {
        if (!e.path)
          throw new Error(
    ...
    function de(e, t, n, i) {
      return new F(e, t, n).ComputeDiff(i)
    }
    class fe {
      constructor(e) {
        const t = [],
      ...
      static computeLinks(
        ...
        const n = (function () {
          if (null === Me) {
            ...
            const e =
              ' \t<>\'"、。｡､，．：；‘“〈《「『【〔（［｛｢｣｝］）〕】』」》〉”’｀～…'
            for (let t = 0; t < e.length; t++) Me.set(e.charCodeAt(t), 1)
            const t = '.,;'
            for (let e = 0; e < t.length; e++) Me.set(t.charCodeAt(e), 2)
          }
          return Me
        })()
        const i = []
    ...
    class We {
      ...
      fire(e) {
        ...
        if (this._listeners) {
          ...
          for (const t of this._listeners) this._deliveryQueue.push([t, e])
          for (
      ...
      dispose() {
        ...
        null === (e = this._listeners) || void 0 === e || e.clear(),
          ...
          null === (n = this._leakageMon) || void 0 === n || n.dispose(),
          (this._disposed = !0)
      }
    }
    We._noop = function () {}
    ...
    class Mt extends ce {
      ...
      setEndPosition(e, t) {
        return 0 === this.getDirection()
          ? new Mt(this.startLineNumber, this.startColumn, e, t)
          : new Mt(e, t, this.startLineNumber, this.startColumn)
      }
      getPosition() {
      ...
      setStartPosition(e, t) {
        return 0 === this.getDirection()
          ? new Mt(e, t, this.endLineNumber, this.endColumn)
          : new Mt(this.endLineNumber, this.endColumn, e, t)
      }
      static fromPositions(e, t = e) {
      ...
      static createWithDirection(e, t, n, i, r) {
        return 0 === r ? new Mt(e, t, n, i) : new Mt(n, i, e, t)
      }
    }
    class Pt {
      constructor(e, t, n) {
    ...
    class Ut extends class {
      ...
      getWordAtPosition(e, t) {
        const n = (function e(t, n, i, r, s = Ae) {
      ...
      computeMoreMinimalEdits(e, t) {
        return kt(this, void 0, void 0, function* () {
          ...
          for (let { range: e, text: s, eol: o } of t) {
            if (('number' == typeof o && (r = o), ce.isEmpty(e) && !s)) continue
            const t = n.getValueInRange(e)
            if (((s = s.replace(/\r\n|\n|\r/g, n.eol)), t === s)) continue
            if (Math.max(s.length, t.length) > Dt._diffLimit) {
            ...
            if (e)
              for (const n of e.words(s))
                if (
                  n !== t &&
                  isNaN(Number(n)) &&
                  (o.add(n), o.size > Dt._suggestionsLimit)
                )
                  break e
          }
